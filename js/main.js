...
var HEIGHT, WIDTH, windowHalfX, windowHalfY, xTarget, yTarget, mousePos = {
  x: 0,
  y: 0
};
var dist = 0;
...
export default class Main {
  ...
  loop() {
    this.render()
    xTarget = (mousePos.x - windowHalfX)
    yTarget = (mousePos.y - windowHalfY)
